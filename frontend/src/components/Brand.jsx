        ...
        <Container>
            <Row>
                ...
                <Col className='p-5' xs={12} lg={6}>
                    ...
                    <Row className='p-4'>
                        <Col><strong><CountUp end={10} enableScrollSpy />+</strong> <br /> years of experience</Col>
                        <Col><strong><CountUp end={12} enableScrollSpy />+</strong> <br /> projects completed</Col>
                    </Row>
                    <Row className='p-4'>
                        <Col><strong><CountUp end={20} enableScrollSpy/>+</strong> <br /> Mn. Sq. Ft. Delivered</Col>
                        <Col><strong><CountUp end={25} enableScrollSpy/>+</strong> <br /> Ongoing Projects</Col>
                    </Row>
                    <Row className='p-4'>
